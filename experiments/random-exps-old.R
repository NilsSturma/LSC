...
# Save as RData file
#name=paste("experiments/O", nNodes-nLat, "L", nLat, "-old.RData", sep="")
...
# Save as json
name=paste("experiments/O", nNodes-nLat, "L", nLat, "-old.json", sep="")
...
print(table)
write.table(table, file = paste("experiments/O", nNodes-nLat, "L", nLat, "-old.txt", sep=""),
